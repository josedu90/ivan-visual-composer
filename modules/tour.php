...
if( !class_exists('Ivan_VC_Tour') ) {
	class Ivan_VC_Tour {
		...
		function __construct() {
			...
			add_filter( 'ivan_vc_tour_shortcode_before', array($this, 'shortcode_before'), 10, 3 );
			add_filter( 'ivan_vc_tour_shortcode_after', array($this, 'shortcode_after'), 15, 3 );
		...
		public function shortcode_admin($output, $obj) {
			...
			if('WPBakeryShortCode_VC_Tour' == get_class($obj) ) {
				...
				$output = str_replace('wpb_tour wpb_content_element', 'wpb_tour wpb_content_element ' . str_replace('.', '', $this->prefix), $output);
			}
		...
		public function shortcode_before($output, $atts, $content) {
			...
			if(!is_admin())
				$output = '<div class="ivan-tour-wrap '.$disable_nav.' '.str_replace('.', '', $this->prefix).'">';
		...
		public $selectors = array(
			'tabs_css' => array(
				...
				// Spacing
				'margin-top' => '.wpb_tabs_nav li',
				'margin-right' => '.wpb_tabs_nav li',
				'margin-bottom' => '.wpb_tabs_nav li',
				...
				// Bg
				'background-color' => '.wpb_tabs_nav a',
				// Border Radius
				...
				// Hovers
				'color-hover' => '.wpb_tabs_nav a:hover, .wpb_tabs_nav li.ui-tabs-active a',
			...
			'prev_next_css' => array(
				// Font
				'font-family' => '.wpb_tour_next_prev_nav a',
				'font-weight' => '.wpb_tour_next_prev_nav a',
				'font-size' => '.wpb_tour_next_prev_nav a',
				'line-height' => '.wpb_tour_next_prev_nav a',
				'text-transform' => '.wpb_tour_next_prev_nav a',
				'color' => '.wpb_tour_next_prev_nav a',
				// Spacing
				//'margin-top' => '.wpb_tabs_nav',
				//'margin-right' => '.wpb_tabs_nav li',
				//'margin-bottom' => '.wpb_tabs_nav',
				//'margin-left' => '.wpb_tabs_nav li',
				'padding-top' => '.wpb_tour_next_prev_nav a',
				'padding-right' => '.wpb_tour_next_prev_nav a',
				'padding-bottom' => '.wpb_tour_next_prev_nav a',
				'padding-left' => '.wpb_tour_next_prev_nav a',
				// Bg
				'background-color' => '.wpb_tour_next_prev_nav a',
				// Border Radius
				'border-top-left-radius' => '.wpb_tour_next_prev_nav a',
				'border-top-right-radius' => '.wpb_tour_next_prev_nav a',
				'border-bottom-left-radius' => '.wpb_tour_next_prev_nav a',
				'border-bottom-right-radius' => '.wpb_tour_next_prev_nav a',
				// Border
				'border-top-width' => '.wpb_tour_next_prev_nav a',
				'border-right-width' => '.wpb_tour_next_prev_nav a',
				'border-bottom-width' => '.wpb_tour_next_prev_nav a',
				'border-left-width' => '.wpb_tour_next_prev_nav a',
				'border-style' => '.wpb_tour_next_prev_nav a',
				'border-color' => '.wpb_tour_next_prev_nav a',
				// Hovers
				'color-hover' => '.wpb_tour_next_prev_nav a:hover',
				'border-color-hover' => '.wpb_tour_next_prev_nav a:hover',
				'background-color-hover' => '.wpb_tour_next_prev_nav a:hover',
			),
		);
	...
	// Ignition!
	global $ivan_vc_tour;
	$ivan_vc_tour = new Ivan_VC_Tour();

	if ( !function_exists( 'vc_theme_vc_tour' ) ) {
		function vc_theme_before_vc_tour($atts, $content = null) {
			return apply_filters( 'ivan_vc_tour_shortcode_before', '', $atts, $content );
		}
	}

	if ( !function_exists( 'vc_theme_after_vc_tour' ) ) {
		function vc_theme_after_vc_tour($atts, $content = null) {
			return apply_filters( 'ivan_vc_tour_shortcode_after', '', $atts, $content );
		}
	}
